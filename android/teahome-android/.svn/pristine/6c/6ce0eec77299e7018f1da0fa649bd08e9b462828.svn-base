...
import com.haorenao.app.adapter.ListViewActiveAdapter;
...
import com.haorenao.app.widget.UserInfoDialog;
...
public class UserCenter extends BaseActivity{
    ...
    private void initLvActive() {
    	...
    	lvActiveAdapter = new ListViewActiveAdapter(this, lvActiveData, R.layout.shop_listitem, false); 
