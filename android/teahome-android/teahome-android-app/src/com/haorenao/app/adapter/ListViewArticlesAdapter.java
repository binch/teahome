...
public class ListViewArticlesAdapter extends BaseAdapter {
	...
	private List<Article> 					listItems;//数据集合
	 ...
	 * @param resource
	 */
	public ListViewArticlesAdapter(Context context, List<Article> data,int resource) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			listItemView.summary = (TextView)convertView.findViewById(R.id.article_listitem_summary);
			listItemView.pic= (ImageView)convertView.findViewById(R.id.article_listitem_pic);
		...
		bmpManager.loadBitmap(article.getPic_url(), listItemView.pic);
