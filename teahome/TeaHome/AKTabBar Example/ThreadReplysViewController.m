...
-(void)viewDidAppear:(BOOL)animated
{
    ...
    NSString *urlStr = [NSString stringWithFormat:@"%@%@&thread=%d&username=%@",CMD_URL,update_comment_cmd,[[self.thread objectForKey:@"id"] intValue],TeaHomeAppDelegate.username];
