...
//    int bid = [[board objectForKey:@"id"] intValue];
    ...
    UILabel *unreadLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, holderView.bounds.size.height - 23, holderView.frame.size.width - 30, 20)];
    unreadLabel.numberOfLines = 0;
    unreadLabel.textAlignment = NSTextAlignmentRight;
    unreadLabel.font = [UIFont systemFontOfSize:15];
